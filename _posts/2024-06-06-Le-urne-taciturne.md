...
{: .text-justify}
Si reclama un'occasione di riscatto, il diritto ad una battaglia campale, ad uno scontro in campo aperto in cui affrontare finalmente e senza sotterfugi l'AvversarioIo. E invece ci tocca lo stillicidio di una guerriglia spirituale. A poco a poco: quel che so è che ce la dovremo guadagnare con la tribolazione di un santo martirio questa apocalisse. Che non ci pioverà sulla testa, così gratuitamente, con un grappolo di bombe atomiche. Che ci vuole *Passione* per meritarsi di salire sulla propria Croce.
{: .text-justify}
