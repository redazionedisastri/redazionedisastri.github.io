...
{: .text-justify}
Stando a sentire la vulgata costruttivista, parrebbe proprio di sì: girovagando per il web mi sono imbattuto [in questo interessante articolo](https://cadehildreth.com/gender-spectrum/), in cui l’autore – un biologo, blogger ed “imprenditore LGBTQ+” – sostiene appunto che non soltanto il genere, ma persino il sesso biologico umano non sia riducibile alla dicotomia maschile/femminile, ovvero a due categorie rigidamente distinte e mutualmente esclusive ([teoria cosiddetta del *binarismo di genere*](https://en.wikipedia.org/wiki/Gender_binary)); esso corrisponderebbe piuttosto ad uno *spettro*, cioè ad un continuum nel quale è unicamente possibile rintracciare due picchi o modi statistici (teoria cosiddetta *bimodale*). 
{: .text-justify}
