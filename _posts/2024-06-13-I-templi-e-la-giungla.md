...
{: .text-justify}  
D’altra parte, per questi soggetti, **il valore dei soldi è oramai ampiamente relativo**: come nelle fasi terminali di una partita di Monopoli, l’enorme sperequazione nella distribuzione delle ricchezze fa sì che i quattrini costituiscano per loro un bene largamente sacrificabile. Come fossero colombi, essi possono permettersi di gettare banconote e assegni fuori dalla finestra, per poi vederseli rincasare, ancor più pasciuti di prima. 
